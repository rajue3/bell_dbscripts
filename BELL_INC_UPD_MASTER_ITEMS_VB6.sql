...
BEGIN              
 ...
 RATE1=@RATE1,RATE2=@RATE2,RATE3=@RATE3,STOCK=@STOCK, OFFERAVAILABLE=@OFFERAVAILABLE,OFFERITEMNAME=@OFFERITEMNAME,OFFERPAKS=@OFFERPAKS,OFFER_QTY_AVAIL=@OFFERQTY,  
