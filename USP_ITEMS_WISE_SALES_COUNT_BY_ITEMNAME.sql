...
--  USP_ITEMS_WISE_SALES_COUNT_BY_ITEMNAME 'byarea','[BHADRACHALAM]','ALL','ALL','2025-07-01','2025-08-30'  
...
--DROP TABLE Bell_REPORT_HEADER      
 IF OBJECT_ID(N'dbo.Bell_TEMP_REPORT', N'U') IS NOT NULL
BEGIN
    -- Use DELETE to retain logging/triggers; TRUNCATE is faster but has different permissions/effects
    DELETE FROM dbo.Bell_TEMP_REPORT;
END
IF OBJECT_ID(N'dbo.Bell_REPORT_HEADER', N'U') IS NOT NULL
BEGIN
    -- Use DELETE to retain logging/triggers; TRUNCATE is faster but has different permissions/effects
    DELETE FROM dbo.Bell_REPORT_HEADER;
END
set @query2 = ''      
